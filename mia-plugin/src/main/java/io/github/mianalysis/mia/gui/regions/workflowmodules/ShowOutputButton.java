...
public class ShowOutputButton extends JButton implements ActionListener, MouseListener {
        ...
        private static SVGDocument eyeSvgDoc = loader.load(ShowOutputButton.class.getResource("/icons/eyeopen.svg"));
        private static SVGDocument eyeHoverSvgDoc = loader
                        .load(ShowOutputButton.class.getResource("/icons/eyeopen_hover.svg"));
        ...
        public void updateState() {
                ...
                // if ((state && module.isEnabled()) && module.isReachable() &&
                // module.isRunnable()) {
                // if (isDark)
                ...
                setIcon(new SVGIcon(eyeSvgDoc, size, size));
        ...
        public void mouseEntered(MouseEvent e) {
                setIcon(new SVGIcon(eyeHoverSvgDoc, size, size));
        }
