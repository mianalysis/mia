...
public class ConcatenateStacksTest extends ModuleTest {
    ...
    public void testRunApplyConcatenate2D8bitX() throws Exception {
        ...
        String pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/noisygradient/NoisyGradient2D_8bit.zip").getPath(), "UTF-8");
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/imagefilter/LabelledObjects2D_8bit_2pxGauss2D.zip").getPath(),
                "UTF-8");
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks2D_8bit_X.zip").getPath(),
                "UTF-8");
        ...
        LinkedHashMap<Integer, Parameters> parameterCollections = concatenateStacks
                .getParameterValue(ConcatenateStacks.ADD_INPUT_IMAGE);
    ...
    public void testRunApplyConcatenate2D8bitY() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks2D_8bit_Y.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate2D8bitC() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks2D_8bit_C.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate2D8bitZ() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks2D_8bit_Z.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate2D8bitT() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks2D_8bit_T.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate3D8bitX() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/NoisyGradient2D_8bit_X.zip").getPath(), "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate3D8bitY() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/NoisyGradient2D_8bit_Y.zip").getPath(), "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate3D8bitC() throws Exception {
        ...
        // Loading the test image
        String pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/noisygradient/NoisyGradient3D_8bit.zip").getPath(), "UTF-8");
        ImagePlus ipl = IJ.openImage(pathToImage);
        Image inputImage = ImageFactory.createImage("Test_image1", ipl);
        workspace.addImage(inputImage);

        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/imagefilter/LabelledObjects3D_8bit_2pxMean3D.zip").getPath(),
                "UTF-8");
        ipl = IJ.openImage(pathToImage);
        inputImage = ImageFactory.createImage("Test_image2", ipl);
        workspace.addImage(inputImage);
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks3D_8bit_C.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate3D8bitZ() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks3D_8bit_Z.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate3D8bitT() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks3D_8bit_T.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DCT8bitC() throws Exception {
        ...
        // Loading the test image
        String pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/noisygradient/NoisyGradient4D_CT_8bit.zip").getPath(), "UTF-8");
        ImagePlus ipl = IJ.openImage(pathToImage);
        Image inputImage = ImageFactory.createImage("Test_image1", ipl);
        workspace.addImage(inputImage);

        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/labelledobjects/LabelledObjects4D_CT_8bit.zip").getPath(),
                "UTF-8");
        ipl = IJ.openImage(pathToImage);
        inputImage = ImageFactory.createImage("Test_image2", ipl);
        workspace.addImage(inputImage);
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DCT_8bit_C.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DCZ8bitC() throws Exception {
        ...
        // Loading the test image
        String pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/noisygradient/NoisyGradient4DCZ_8bit_C_full.zip").getPath(),
                "UTF-8");
        ImagePlus ipl = IJ.openImage(pathToImage);
        Image inputImage = ImageFactory.createImage("Test_image1", ipl);
        workspace.addImage(inputImage);
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/labelledobjects/LabelledObjects4D_CZ_8bit.zip").getPath(),
                "UTF-8");
        ipl = IJ.openImage(pathToImage);
        inputImage = ImageFactory.createImage("Test_image2", ipl);
        workspace.addImage(inputImage);
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DCZ_8bit_C.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DZT8bitC() throws Exception {
        ...
        // Loading the test image
        String pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/noisygradient/NoisyGradient4D_ZT_8bit_C1.zip").getPath(), "UTF-8");
        ImagePlus ipl = IJ.openImage(pathToImage);
        Image inputImage = ImageFactory.createImage("Test_image1", ipl);
        workspace.addImage(inputImage);

        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/imagefilter/LabelledObjects4D_8bit_2pxMedian3D.zip").getPath(),
                "UTF-8");
        ipl = IJ.openImage(pathToImage);
        inputImage = ImageFactory.createImage("Test_image2", ipl);
        workspace.addImage(inputImage);
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DZT_8bit_C.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DCT8bitZ() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DCT_8bit_Z.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DCZ8bitZ() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DCZ_8bit_Z.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DZT8bitZ() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/labelledobjects/LabelledObjects4D_8bit.zip").getPath(), "UTF-8");
        ipl = IJ.openImage(pathToImage);
        inputImage = ImageFactory.createImage("Test_image2", ipl);
        workspace.addImage(inputImage);

        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DZT_8bit_Z.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DCT8bitT() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DCT_8bit_T.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DCZ8bitT() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DCZ_8bit_T.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate4DZT8bitT() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks4DZT_8bit_T.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate5D8bitC() throws Exception {
        ...
        // Loading the test image
        String pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/noisygradient/NoisyGradient5D_8bit.zip").getPath(), "UTF-8");
        ImagePlus ipl = IJ.openImage(pathToImage);
        Image inputImage = ImageFactory.createImage("Test_image1", ipl);
        workspace.addImage(inputImage);

        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/imagefilter/LabelledObjects5D_8bit_2pxMean3D.zip").getPath(),
                "UTF-8");
        ipl = IJ.openImage(pathToImage);
        inputImage = ImageFactory.createImage("Test_image2", ipl);
        workspace.addImage(inputImage);
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks5D_8bit_C.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate5D8bitZ() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/NoisyGradient2D_8bit_Z.zip").getPath(), "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate5D8bitT() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/ConcatenateStacks5D_8bit_T.zip").getPath(),
                "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate5D8bitCUnequal() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/NoisyGradient2D_8bit_C.zip").getPath(), "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
    ...
    public void testRunApplyConcatenate5D8bitTUnequal() throws Exception {
        ...
        pathToImage = URLDecoder.decode(
                this.getClass().getResource("/images/concatenatestacks/NoisyGradient2D_8bit_T.zip").getPath(), "UTF-8");
        Image expectedImage = ImageFactory.createImage("Expected", IJ.openImage(pathToImage));
