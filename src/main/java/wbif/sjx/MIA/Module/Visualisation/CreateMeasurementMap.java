...
public class CreateMeasurementMap extends Module {
    ...
    public static void processObjectMeasurement(CumStat[] cumStats, Indexer indexer, ObjCollection objects,
    ...
    public static void processParentMeasurements(CumStat[] cumStats, Indexer indexer, ObjCollection objects,
