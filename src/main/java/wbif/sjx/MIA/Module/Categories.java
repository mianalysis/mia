...
public class Categories {
        ...
        public final static Category IMAGE_PROCESSING_MISCELLANEOUS = new Category("Miscellaneous",
                        "General image processing operations, such as setting spatial calibration.",
                        IMAGE_PROCESSING);
        public final static Category IMAGE_PROCESSING_PIXEL = new Category("Pixel",
                        ...
                        IMAGE_PROCESSING);
        public final static Category IMAGE_PROCESSING_PIXEL_BINARY = new Category("Binary",
                        ...
                        IMAGE_PROCESSING_PIXEL);
        public final static Category IMAGE_PROCESSING_PIXEL_THRESHOLD = new Category("Threshold",
                        "Operations binarising images from the workspace.  Thresholds can be calculated automatically or applied manually. ",
                        IMAGE_PROCESSING_PIXEL);
        public final static Category IMAGE_PROCESSING_STACK = new Category("Stack",
        ...
        public final static Category MISCELLANEOUS = new Category("Miscellaneous",
                        "Miscellaneous modules which don't fit into fixed categories.  Includes global variable definitions and macro handling.",
                        ROOT);
        public final static Category MISCELLANEOUS_MACROS = new Category("Macros",
        ...
        public final static Category OBJECT_MEASUREMENTS = new Category("Object measurements",
                        ...
                        ROOT);
        public final static Category OBJECT_MEASUREMENTS_INTENSITY = new Category("Intensity",
        ...
        public final static Category OBJECT_MEASUREMENTS_MISCELLANEOUS = new Category("Miscellaneous",
                        ...
                        OBJECT_MEASUREMENTS);
        public final static Category OBJECT_MEASUREMENTS_SPATIAL = new Category("Spatial",
                        "Modules performing spatial-based measurements on objects in the workspace.",
                        OBJECT_MEASUREMENTS);

        public final static Category OBJECT_PROCESSING = new Category("Object processing",
                        "Operations capable of creating new objects, changing existing ones or creating new object relationships.",
                        ROOT);
        public final static Category OBJECT_PROCESSING_IDENTIFICATION = new Category("Identification",
                        "Modules resulting in creation of new objects to be stored in the workspace.",
                        OBJECT_PROCESSING);
        public final static Category OBJECT_PROCESSING_MISCELLANEOUS = new Category("Miscellaneous",
                        "Operations which allow conversion between objects and images.", OBJECT_PROCESSING);
        public final static Category OBJECT_PROCESSING_REFINEMENT = new Category("Refinement",
        ...
        public final static Category OBJECT_PROCESSING_REFINEMENT_MERGE_OBJECTS = new Category("Merge objects",
                        ...
                        OBJECT_PROCESSING_REFINEMENT);
        public final static Category OBJECT_PROCESSING_RELATIONSHIPS = new Category("Relationships",
        ...
        public final static Category WORKFLOW_HANDLING = new Category("Workflow handling",
