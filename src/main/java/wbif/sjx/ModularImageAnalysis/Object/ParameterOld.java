//// TODO: Implement generic type (ParameterOld<T>).  This would require INPUT_IMAGE_1, etc. to be created as classes
...
// */
//public class ParameterOld implements Serializable {
//    /**
...
//
////    /**
////     * Controls adding and removing parameters.  For example, adding object filters or overlay elements.
////     */
////    public final static int ADD_PARAMETER = 20;
//
//
...
//    // CONSTRUCTORS
//
//    public ParameterOld(String name, int type, Object value, Object valueSource) {
//        this.type = type;
//        this.name = name;
//        this.value = value;
...
//    }
//
//    public ParameterOld(String name, int type, Object value) {
//        this.type = type;
//        this.name = name;
//        this.value = value;
