...
public class ExpandShrinkObjects extends Module {
    ...
    public static Obj processObject(Obj inputObject, Image templateImage, String method, int radiusChangePx) {
        ...
        Image objectImage = objectCollection.convertObjectsToImage("Object image", templateImage, hues, 8);
    ...
    protected boolean run(Workspace workspace) {
        ...
        if (showOutput) {
            if (updateInputObjects) {
                ...
                inputObjects.convertObjectsToImage("Objects", null, hues, 8).getImagePlus().show();
            } else {
