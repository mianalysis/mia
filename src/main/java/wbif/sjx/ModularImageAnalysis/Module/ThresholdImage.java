...
public class ThresholdImage extends HCModule {
    ...
    public void execute(HCWorkspace workspace, boolean verbose) {
        ...
        if (thresholdMode.equals(HUANG)) {
            ...
            Object[] results1 = auto_threshold.exec(inputImagePlus,"Huang",true,false,true,true,false,true);
            inputImagePlus = Threshold.threshold(inputImagePlus,(Integer) results1[0]*thrMult,Integer.MAX_VALUE);

        } else if (thresholdMode.equals(OTSU)) {
            if (verbose) System.out.println("["+moduleName+"] Applying global Huang threshold (multplier = "+thrMult+" x)");
            Auto_Threshold auto_threshold = new Auto_Threshold();
            Object[] results1 = auto_threshold.exec(inputImagePlus,"Otsu",true,false,true,true,false,true);
            inputImagePlus = Threshold.threshold(inputImagePlus,(Integer) results1[0]*thrMult,Integer.MAX_VALUE);
