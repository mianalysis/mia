...
public class DocumentationGenerator {
    ...
    public void run() throws IOException {
        ...
        File guideRoot = new File(DocumentationGenerator.class.getResource("/guides").getFile());
        System.out.println(guideRoot);
    ...
    String getGuidePathToRoot(File file) {
        if (file.getName().equals("guides"))
            return "";

        return getGuidePathToRoot(file.getParentFile()) + "../";
