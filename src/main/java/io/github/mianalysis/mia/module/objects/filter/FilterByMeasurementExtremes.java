...
public class FilterByMeasurementExtremes extends AbstractObjectFilter {
	...
	*/
    ...
    public static ArrayList<Integer> getIDsToRemove(Objs inputObjects, String measName, String filterMethod, boolean perTimepoint, int nMeas) {
    ...
    public static HashMap<Integer,double[]> getMeasurementExtremes(Objs objects, String measurementName, boolean perTimepoint, int nMeas) {
        HashMap<Integer, double[]> minMax = new HashMap<>();
        
        // Iterating over all frames, getting the objects and identifying limits for min and max
    ...
    protected Status process(Workspace workspace) {
        ...
        if (perParent) {
            ...
            for (Obj parentObject:parentObjects.values()) {
                Objs childObjects = parentObject.getChildren(inputObjectsName);
    ...
    protected void addParameterDescriptions() {
        ...
        parameters.get(N_MEASUREMENTS).setDescription("Number of objects with the most extreme measurements to remove or retain.  If an insufficient number of objects are available, the most possible will be used.");
