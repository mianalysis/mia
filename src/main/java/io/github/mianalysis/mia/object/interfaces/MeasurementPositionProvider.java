package io.github.mianalysis.mia.object.interfaces;
...
public interface MeasurementPositionProvider {
    ...
    */
    ...
    default double[] getObjectPosition(Obj object, Parameters parameters) {
        String positionMode = parameters.getValue(POSITION_MODE, null);
        switch (positionMode) {
            case PositionModes.OBJECT_CENTROID:
            default:
                return new double[]{object.getXMean(true), object.getYMean(true), object.getZMean(true,true)};
