...
public class ImageFactory {
    public static <T extends RealType<T> & NativeType<T>> Image<T> createImage(String name, ImagePlus imagePlus, ImageType imageType) {
        switch (imageType) {
            case IMAGEPLUS:
    ...
    public static <T extends RealType<T> & NativeType<T>> Image<T> createImage(String name, ImgPlus img, ImageType imageType) {
        switch (imageType) {
            case IMAGEPLUS:
