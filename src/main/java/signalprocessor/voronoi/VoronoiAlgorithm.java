...
import signalprocessor.voronoi.eventqueue.VCircleEvent;
import signalprocessor.voronoi.eventqueue.VEvent;
import signalprocessor.voronoi.eventqueue.VSiteEvent;
import signalprocessor.voronoi.representation.RepresentationInterface;
import signalprocessor.voronoi.statusstructure.AbstractStatusStructure;
...
public class VoronoiAlgorithm {
    ...
    protected static void generateVoronoi(RepresentationInterface datainterface, Collection<VPoint> points, Graphics2D g, VPoint attentiontopoint, int attentiontopos) {
        ...
        VEvent.uniqueid = 1;
        signalprocessor.voronoi.statusstructure.binarysearchtreeimpl.BSTStatusStructure.uniqueid = 1;
