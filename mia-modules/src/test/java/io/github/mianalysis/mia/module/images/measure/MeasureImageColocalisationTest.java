...
//         ImageI expectedImage = ImageFactories.getDefaultFactory().create("Expected",expectedIpl);
...
//         ImageI maskImage = ImageFactories.getDefaultFactory().create("Mask", maskIpl);        
