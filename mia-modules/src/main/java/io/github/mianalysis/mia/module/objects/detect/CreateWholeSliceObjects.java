    ...
    */
    ...
    public static ObjsI process(ImageI inputImage, String outputObjectsName, String outputMode) {
        ...
        for (ObjI outputObject : outputObjects.values()) {
            outputObject.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.TIMEPOINT, outputObject.getT()));
            ...
            switch (outputMode) {
                ...
                default:
                    ...
                    if (pt != null)
                        outputObject.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.SLICE, pt.z));
                    break;
            }
        }
