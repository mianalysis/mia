...
public class AddFromPositionMeasurement extends AbstractOverlay {
	...
	*/
    ...
    public static void addOverlay(ObjI object, ImagePlus ipl, Color colour, String size, String type, double lineWidth, String[] posMeasurements, @Nullable String radiusMeasurement, boolean renderInAllFrames) {
