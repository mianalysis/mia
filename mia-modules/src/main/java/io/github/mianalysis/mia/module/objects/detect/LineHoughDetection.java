...
public class LineHoughDetection extends AbstractHoughDetection {
    ...
    */
    ...
    public LineHoughDetection(ModulesI modules) {
            ...
            for (int z = 0; z < ipl.getNSlices(); z++) {
                for (int t = 0; t < ipl.getNFrames(); t++) {
                    ...
                    for (double[] line : lines) {
                        ...
                        outputObject.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.ORIENTATION, thetaD));
