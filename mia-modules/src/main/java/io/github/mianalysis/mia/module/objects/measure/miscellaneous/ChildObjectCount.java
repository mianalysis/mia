 ...
 * this value can optionally be evaluated at the time of use, so should always be
 * up to date.
 */
...
public class ChildObjectCount extends Module {
    ...
    */
    ...
    void addParameterDescriptions() {
        ...
        parameters.get(LIVE_MEASUREMENT).setDescription("When selected, the child object count will be evaluated at the time of access, "
