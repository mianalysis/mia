 ...
 * <br>
 * This module uses the <a href="https://imagej.net/Feature_Extraction">Feature
 * Extraction</a> plugin and associated MPICBG tools to detect MOPS
 * ("Multi-Scale Oriented Patches") features from the input images and calculate
 * and apply the necessary 2D affine transforms.<br>
 * <br>
 * References: Brown, Matthew and Szeliski, Richard "Multi-image feature
 * matching using multi-scale oriented patches". US Patent 7,382,897 (June 3,
 * 2008).
 */
...
public class AffineMOPS extends AbstractAffineRegistration {
    ...
    */
    ...
    /**
     * "Keypoint candidates are extracted at all scales between maximum image size
     * and minimum image size. This Scale Space is represented in octaves each
     * covering a fixed number of discrete scale steps from σ0 to 2σ0. More steps
     * result in more but eventually less stable keypoint candidates. Tip: Keep 3 as
     * suggested by Lowe (2004) and do not use more than 10.". Description taken
     * from <a href=
    ...
    /**
     * "The MOPS-descriptor is simply a nxn intensity patch with normalized
     * intensities. Brown (2005) suggests n=8. We found larger descriptors with n
     * greater than 16 perform better for Transmission Electron Micrographs from
     * serial sections.". Description taken from <a href=
     * "https://imagej.net/Feature_Extraction">https://imagej.net/Feature_Extraction</a>
     */
    public static final String FD_SIZE = "Feature descriptor size";

    /**
     * "For SIFT-descriptors, this is the number of orientation bins b per 4×4px
     * block as described above. Tip: Keep the default value b=8 as suggested by
     * Lowe (2004).". Description taken from <a href=
     * "https://imagej.net/Feature_Extraction">https://imagej.net/Feature_Extraction</a>
     */
    ...
    public AffineMOPS(ModulesI modules) {
