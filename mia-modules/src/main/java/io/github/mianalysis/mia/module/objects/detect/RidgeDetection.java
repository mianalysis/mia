...
public class RidgeDetection extends Module {
    ...
    */
    ...
    public static void addMeasurements(ObjI object, double estimatedLength, @Nullable CumStat width) {
        ...
        object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.LENGTH_PX, estimatedLength));
        object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.LENGTH_CAL, estimatedLength * dppXY));

        if (width == null) {
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.MEAN_HALFWIDTH_PX, Double.NaN));
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.STDEV_HALFWIDTH_PX, Double.NaN));
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.MEAN_HALFWIDTH_CAL, Double.NaN));
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.STDEV_HALFWIDTH_CAL, Double.NaN));
        } else {
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.MEAN_HALFWIDTH_PX, width.getMean()));
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.STDEV_HALFWIDTH_PX, width.getStd()));
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.MEAN_HALFWIDTH_CAL, width.getMean() * dppXY));
            object.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(Measurements.STDEV_HALFWIDTH_CAL, width.getStd() * dppXY));
        }
    }
