...
public class MeasureSpecificWidth extends Module {
	...
	*/
    ...
    public MeasureSpecificWidth(final ModulesI modules) {
    ...
    static void addMeasurements(ObjI obj, WidthMeasurementResult result, String prefix) {
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.WIDTH_PX, prefix), result.calculateWidth(true)));
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.WIDTH_CAL, prefix), result.calculateWidth(false)));
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.X1_PX, prefix), result.getEnd1().x));
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.Y1_PX, prefix), result.getEnd1().y));
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.Z1_SLICE, prefix), result.getEnd1().z));
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.X2_PX, prefix), result.getEnd2().x));
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.Y2_PX, prefix), result.getEnd2().y));
        obj.addMeasurement(MeasurementFactories.getDefaultFactory().createMeasurement(getFullName(Measurements.Z2_SLICE, prefix), result.getEnd2().z));
