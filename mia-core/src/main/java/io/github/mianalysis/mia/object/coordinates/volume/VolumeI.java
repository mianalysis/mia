...
public interface VolumeI {
    ...
    public default void initialise(CoordinateSetFactoryI factory, int width, int height, int nSlices, double dppXY, double dppZ,
    String units) {
    ...
    // public default Point<Double> getMeanCentroid(boolean pixelDistances, boolean matchXY) {
