...
public class ChildObjectsP extends ChoiceType {
    ...
    public ChildObjectsP(String name, ModuleI module) {
        super(name, module);
    }

    public ChildObjectsP(String name, ModuleI module, String description) {
        super(name, module, description);
    }

    public ChildObjectsP(String name, ModuleI module, @NotNull String choice, @NotNull String parentObjectsName) {
        super(name, module);
        this.choice = choice;
        this.parentObjectsName = parentObjectsName;
    }

    public ChildObjectsP(String name, ModuleI module, @NotNull String choice, @NotNull String parentObjectsName, String description) {
        super(name, module, description);
        this.choice = choice;
        this.parentObjectsName = parentObjectsName;
    }
    ...
    public <T extends Parameter> T duplicate(ModuleI newModule) {
        ChildObjectsP newParameter = new ChildObjectsP(getName(),newModule,getRawStringValue(),parentObjectsName,getDescription());
